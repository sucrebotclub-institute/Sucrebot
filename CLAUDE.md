...
- Auditar `cache:'no-store'` en el resto de páginas con `fetch(GAS...)` propio (ESCANER, etc.) — se encontró y corrigió el mismo bug en CRONOMETRO/PANEL-CALIFICACION/MANILLAS/PANEL-BRACKET, no se revisaron todas.
