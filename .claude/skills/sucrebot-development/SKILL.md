...
- [ ] **Activar `RESULTADOS_ABIERTO_AL_PUBLICO = true`** cuando Raku confirme la fecha (previsto ~1 día antes del evento) — actualmente oculto al público, solo staff logueado lo ve
